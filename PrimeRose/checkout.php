...
<body>
   ...
   <section class="checkout">
      ...
      <form action="https://formspree.io/f/mbjbazjl" method="post">
         ...
         <div class="user-info">
            ...
            <a href="update_address.php" class="btn">Send this to?</a>
            
            <input type="submit" value="place order" class="btn <?php if ($fetch_profile['address'] == '') 
            {
               echo 'disabled';
            } 
               ?>" style="width:100%; background:var(--red); color:var(--black);" name="submit">
         </div>
